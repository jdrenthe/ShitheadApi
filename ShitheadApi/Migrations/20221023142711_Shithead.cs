...
{
    public partial class Shithead : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deacks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationSubscription_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2c9e7ed6-ddb0-446c-8d9c-ad6e855cdc1b"), "44eaa058-d02b-401d-b472-f9bb8ad6e4b9", "Shithead_User_Can_Read_Write", "SHITHEAD_USER_CAN_READ_WRITE" });

            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("92db1fc3-2de7-4e92-bc5d-2352ad6cd0d6"), "d10bafb7-4782-4a99-82f5-4cb7afcf71e2", "Shithead_Administrator_Off_All", "SHITHEAD_ADMINISTRATOR_OFF_ALL" });
